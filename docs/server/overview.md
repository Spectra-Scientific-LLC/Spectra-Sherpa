...
SpectraSherpa can be deployed as a multi-user server or a hybrid cloud extension. This guide covers the operational details for **Hybrid** and **Demo** modes.
...
| **Demo** | Public / Cloud | JWT Required | Enabled | Evaluation, training, public demos. |
...
- **Run Demo Mode** if you are hosting a public-facing instance (e.g., on DigitalOcean) for users to try out the software without installing it.
