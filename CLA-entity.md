...
- **You**: The legal entity identified in the signature block below (the
  "Entity"), acting through its authorized representative
...
3. **"Submission"** means any communication to Spectra intended for inclusion in
   ...
   emailed diffs.
4. **"Designated Employees"** means employees, contractors, or agents of the
   Entity who are authorized by the Entity to make Contributions on its behalf.
   All Designated Employees must be identified by GitHub username in the
   Schedule below or in writing to Spectra.
...
to assert moral rights or similar rights in Contributions made by Designated
Employees against Spectra, its licensees, transferees, or downstream
recipients.

### 2.4 Spectra's Rights

You acknowledge that Spectra is not obligated to use any Contribution as
...
1. You are a legally formed entity and the signatory is authorized to bind
   the Entity to this Agreement.
2. Each Submission is original work created by Designated Employees, or You
   have sufficient rights to submit it and grant the license under this
   Agreement.
3. Your Submissions do not knowingly infringe third-party intellectual
   property rights.
4. You will identify any third-party code, data, or content included in a
   Submission and its applicable license terms.
5. You have ensured that any intellectual property policies of the Entity
   permit the grant of rights under this Agreement.

## 5. Designated Employee Management

1. You will maintain a current list of Designated Employees and notify Spectra
   of additions or removals in writing (email or pull request).
2. Contributions by individuals not listed as Designated Employees are not
   covered by this Agreement and require a separate Individual CLA.
3. When a Designated Employee leaves the Entity, their Contributions made
   during employment remain covered. Future personal Contributions require
   an Individual CLA.

## 6. Excluded Contributions

You may exclude specific materials from this Agreement only if both:

1. You clearly mark them as excluded at submission time; and
2. Spectra expressly agrees in writing before merge.
...
## Schedule: Designated Employees

| GitHub Username | Name | Email | Date Added |
|-----------------|------|-------|------------|
|                 |      |       |            |
