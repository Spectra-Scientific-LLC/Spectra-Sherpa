...
class MixtureComponent(Base):
    ...
    mixture_id: Mapped[int] = mapped_column(ForeignKey("mixture.id"), nullable=False, index=True)
    sample_id: Mapped[int] = mapped_column(ForeignKey("sample.id"), nullable=False, index=True)
