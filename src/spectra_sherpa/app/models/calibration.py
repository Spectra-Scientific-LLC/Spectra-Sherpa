...
class Calibration(Base):
    ...
    files = relationship("CalibrationFile", back_populates="calibration", cascade="all, delete-orphan")
    models = relationship("CalModel", back_populates="calibration", cascade="all, delete-orphan")
