...
class EstimatorSpecNode(Node):
    ...
    async def execute(self, X: Any = None, y: Any = None, **kwargs: Any) -> Any:
        ...
        if self.spec.scale:
            ...
            scaler = StandardScaler(with_mean=True, with_std=bool(do_scale))
    ...
    def _auto_export_estimator(
        ...
        if self.spec.scale:
            ...
            lines.append(f"{indent}_scaler = StandardScaler(" f"with_mean=True, with_std={format_value(do_scale)})")
